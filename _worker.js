...
const พร็อกซีไอพีs = ['8.217.121.210'];
...
function getวเลสConfig(userIDs, hostName) {
	const commonUrlPart = `:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2Fvless-ws#Alibaba (HK)`;
	const commonUrlPart2 = `:80?encryption=none&security=randomized&type=ws&host=${hostName}&path=%2Fvless-ws#Alibaba (HK)`;
	const hashSeparator = "===================================";
