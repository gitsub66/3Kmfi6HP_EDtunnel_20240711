...
const พร็อกซีไอพีs = ['207.148.119.153'];
...
function getวเลสConfig(userIDs, hostName) {
	const commonUrlPart = `:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2Fvless-ws#The Constant Company (SG)`;
	const commonUrlPart2 = `:80?encryption=none&security=randomized&type=ws&host=${hostName}&path=%2Fvless-ws#The Constant Company (SG)`;
	const hashSeparator = "===================================";
