...
const พร็อกซีไอพีs = ['13.228.155.72'];
...
function getวเลสConfig(userIDs, hostName) {
	const commonUrlPart = `:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2Fvless-ws#Amazon.com (SG)`;
	const commonUrlPart2 = `:80?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=%2Fvless-ws#Amazon.com (SG)`;
	const hashSeparator = "===================================";
