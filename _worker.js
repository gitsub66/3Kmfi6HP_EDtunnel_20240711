...
const พร็อกซีไอพีs = ['5.161.103.113'];
...
function getวเลสConfig(userIDs, hostName) {
	const commonUrlPart = `:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2Fvless-ws#Hetzner Online GmbH (US)`;
	const commonUrlPart2 = `:80?encryption=none&security=randomized&type=ws&host=${hostName}&path=%2Fvless-ws#Hetzner Online GmbH (US)`;
	const hashSeparator = "===================================";
