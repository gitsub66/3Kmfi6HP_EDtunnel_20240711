...
let hostnames = ['indo.mysant.my.id'];

if (!isValidUUID(userID)) {
	throw new Error('da4d01fb-192c-412f-9ed5-ee5c246020b6');
}
...
<div style="text-align: center;">
  <a href="https://t.me/noir7r" target="_blank" style="text-decoration: none;">Contact Me: <button style="color: #00D69F; background-color: transparent; border: none;">Telegram</button></a>
</div>`;
